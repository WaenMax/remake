...
def acm_params():
    ...
    parser.add_argument('--core_mask_rate_min', type=float, default=0.20)
    parser.add_argument('--core_mask_rate_max', type=float, default=0.30)
    ...
    parser.add_argument('--feature_keep_strength', type=float, default=0.30)
